...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , led_en_o{vlSymsp->TOP.led_en_o}
    , led_ca_o{vlSymsp->TOP.led_ca_o}
    , led_cb_o{vlSymsp->TOP.led_cb_o}
    , led_cc_o{vlSymsp->TOP.led_cc_o}
    , led_cd_o{vlSymsp->TOP.led_cd_o}
    , led_ce_o{vlSymsp->TOP.led_ce_o}
    , led_cf_o{vlSymsp->TOP.led_cf_o}
    , led_cg_o{vlSymsp->TOP.led_cg_o}
    , led_dp_o{vlSymsp->TOP.led_dp_o}
    ...
    , light_o{vlSymsp->TOP.light_o}
    , switch_i{vlSymsp->TOP.switch_i}
